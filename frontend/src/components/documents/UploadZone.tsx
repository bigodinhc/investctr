    ...
    <div className={cn("space-y-4", className)}>
      ...
      <div
        ...
        className={cn(
          ...
          "hover:border-vermillion/50 hover:bg-vermillion/5",
          isDragActive && "border-vermillion bg-vermillion/10",
        ...
        <div className="flex flex-col items-center justify-center text-center">
          <div
            className={cn(
              ...
              isDragActive ? "bg-vermillion/20" : "bg-vermillion/10"
            )}
          >
            <Upload
              className={cn(
                "h-8 w-8 transition-colors",
                isDragActive ? "text-vermillion" : "text-vermillion/70"
              )}
            />
          </div>
            ...
            {files.map((fileData, index) => (
              <div
                ...
                className={cn(
                  ...
                  fileData.status === "uploading" && "bg-vermillion/5 border-vermillion/20",
              ...
              >
                <div
                  className={cn(
                    ...
                    fileData.status === "uploading" && "bg-vermillion/10",
                    fileData.status === "pending" && "bg-vermillion/10"
                  )}
                >
                  {fileData.status === "uploading" ? (
                    <Loader2 className="h-5 w-5 text-vermillion animate-spin" />
